...
See the Pen [Day 8: Metaballs](https://codepen.io/Uberche/pen/yqVgqE/) by Ethan ([@Uberche](https://codepen.io/Uberche)) on [CodePen](https://codepen.io).
...
Before we continue, one optional addition to your setup is [<link rel=”preload”>](https://www.smashingmagazine.com/2016/02/preload-what-is-it-good-for/) from [Resource Hints](https://twitter.com/addyosmani/status/743571393174872064). This gives us a way to declaratively fetch resources without executing them. Preload can be leveraged for preloading Webpack chunks for routes users _are likely_ to navigate to so the cache is already primed with them and they’re instantly available for instantiation.
...
The Webpack community have many web-established analysers for builds including [http://webpack.github.io/analyse/](http://webpack.github.io/analyse/), [](http://webpack.github.io/analyse/) [https://chrisbateman.github.io/webpack-visualizer/](https://chrisbateman.github.io/webpack-visualizer/), [](https://chrisbateman.github.io/webpack-visualizer/) a[n](https://chrisbateman.github.io/webpack-visualizer/)d [](https://chrisbateman.github.io/webpack-visualizer/) [https://alexkuz.github.io/stellar-webpack/.](https://alexkuz.github.io/stellar-webpack/) These are handy for understanding what your largest modules are.
...
Now that we have a build of the chunk-manifest JSON, we need to inline it into our HTML so that Webpack actually has access to it when the page boots up. So include the output of the above in a <script> tag. Automatically inlining this script in HTML can be achieved using the [html-webpack-plugin](https://github.com/ampedandwired/html-webpack-plugin).

_Note: Webpack are hoping to simplify the steps required for this long-term caching setup from ~4–1 by having_ [_no shared ID range_](https://github.com/webpack/webpack/tree/master/examples/explicit-vendor-chunk)_._
...
See the Pen [SNOW GLOBE](https://codepen.io/al-ro/pen/XBXWjm/) by noname ([@al-ro](https://codepen.io/al-ro)) on [CodePen](https://codepen.io).

 ![Elva dressed as a fairy](elva-fairy-800w.jpg)
